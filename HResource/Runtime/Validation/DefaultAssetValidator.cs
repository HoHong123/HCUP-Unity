 ...
 *
 * 사용법 ::
 * AssetProviderFactory.Create 의 기본 validator 로 자동 주입.
 * 도메인별 추가 규칙 (예: GUID 형식 강제) 이 필요하면 IAssetValidator 별도 구현체로 교체.
 *
 * 주의 ::
 * Unity Object 의 == null 은 destroyed instance 에 대해 ReferenceEquals 와 다른 결과를 반환(Unity 의 native object lifecycle 상호작용).
 * 본 validator 는 두 규칙을 명시적으로 분리하여 Unity Object 와 일반 참조형 모두 안전하게 검증.
 * =========================================================
 */
#endif
