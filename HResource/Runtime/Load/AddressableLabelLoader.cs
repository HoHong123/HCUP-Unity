    ...
    public sealed class AddressableLabelLoader<TAsset> : IAddressableLabelLoader<TAsset>
        ...
        public async UniTask<IList<TAsset>> LoadAllAsync(string label) {
            ...
            try {
                ...
                HLogger.Error($"[AddressableLabelLoader] LoadAll failed. Label='{label}' :: {e.Message}");
                return null;
            }
        ...
        private async UniTask<TAsset> _LoadSingleAsync(
            ...
            try {
                ...
                try {
                    ...
                    HLogger.Error($"[AddressableLabelLoader] Load failed. Label='{label}' :: {e.Message}");
                    return null;
                }
                ...
                HLogger.Error($"[AddressableLabelLoader] Location query failed. Label='{label}' :: {e.Message}");
                return null;
            }
            finally {
