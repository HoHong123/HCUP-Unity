 ...
 *
 * 변경 ::
 * OnEnable 이 AssetOwnerIdWatchRegistry.ScanNow 를 부른다.
 *
 * 이유 ::
 * 첫 OnGUI 가 첫 update 틱보다 먼저 온다. 창이 닫혀 있던 사이에 죽은 소유자가
 * 한 프레임 동안 살아있는 행으로 그려졌다.
 *
 * 결과 ::
 * 창을 여는 즉시 표가 현재 상태로 수렴한다.
 *
 * 주의 ::
 * 스캔 주기는 레지스트리가 정한다. 이 창은 시점만 요청한다.
 *
 * =========================================================
