...
/* =========================================================
 * @Jason - PKH
 * HTextLocalizerAddon 컴포넌트의 Custom Editor.
 * Localization ID, UseOriginalText, FitWidth 필드를 Inspector에 노출한다.
 *
 * 사용 ::
 * HTextLocalizerAddon 컴포넌트를 Inspector에서 선택하면 자동 적용된다.
 * =========================================================
 */
...
namespace HUI.Editor.TextUI {
    [CustomEditor(typeof(HTextLocalizerAddon))]
    public class HTextLocalizerAddonEditor : UnityEditor.Editor {
 ...
 *  Dev Log
 * =============================================================================
 * @Jason - PKH 2026.06.29 HTextLocalizerAddonEditor 베이스 코드 생성
 *
 * # 목적
 * - HTextLocalizerAddon 컴포넌트의 필드를 Inspector에서 편집하는 Custom Editor
 *
 * # 사용 흐름
 * - HTextLocalizerAddon 컴포넌트를 Inspector에서 선택하면 [CustomEditor(typeof(HTextLocalizerAddon))]로 자동 적용
 *
 * =============================================================================
 */
#endif
