 ...
 *
 * 특징 ::
 * Odin Inspector 기반 EditorWindow로 구현되어 ScriptableObject를 인라인 편집할 수 있습니다.
 * =========================================================
 */
 ...
 * 사용법 ::
 * 메뉴 ::
 * HCUP → View → File Browser
 *
 * 검색 절차 ::
 * 1. 검색 폴더 설정
 * 2. ScriptableObject 타입 선택
 * 3. Refresh 실행
 *
 * 기타 ::
 * Odin Inspector 기반 EditorWindow입니다.
 * =========================================================
 */
#endif
