...
namespace HUI.TextUI {
    ...
    /// </summary>
    [AddComponentMenu("HCUP/UI/Text/HTmpLocalizerAddon")]
    [RequireComponent(typeof(TextMeshProUGUI))]
    public class HTmpLocalizerAddon : MonoBehaviour {
        #region Fields
        [SerializeField]
        ...
        private void _FitWidth() {
            ...
            float width = textComponent.GetPreferredValues(textComponent.text).x;
